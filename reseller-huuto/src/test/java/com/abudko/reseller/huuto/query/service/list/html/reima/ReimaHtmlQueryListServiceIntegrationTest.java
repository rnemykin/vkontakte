...
public class ReimaHtmlQueryListServiceIntegrationTest {

    @Autowired
    @Qualifier("caseInsensitiveSimpleHtmlParamBuilder")
    ...
    private SearchParams getSearchParams() {
        ...
        searchParams.setWords("Lasten-haalarit--ALE/c/o11?q=:relevance:season:Talvi&text=#");
