...
public class LekmerPriceRulesTest {
    ...
    public void testRoundUp() {
        assertEquals("21", rules.calculateNew("5.51"));
    }

    @Test
    public void testRoundDown() {
        assertEquals("20", rules.calculateNew("5.49"));
    }

    @Test
    public void test() {
        assertEquals("20", rules.calculateNew("5.0"));
    }
    ...
    public void testCurrencyServiceUnavailable() {
        ...
        assertEquals("1040", rules.calculateNew("5.0"));
    }
}
