...
public enum Brand {
    ...
    COLORKIDS("Color", "Color Kids", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, TALVIKENGAT,
    ...
    HALTI("Halti", "Halti", TALVIHOUSUT, TALVITAKKI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI, TALVIKENGAT,
            VALIKAUSIKENGAT), //
    ...
    HUPPA("Huppa", "Huppa", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT,
            SADEHAALARI), //
    ICEPEAK("Ice", "Icepeak", TALVIHAALARI, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI), //
    ...
    LEGO("Lego", "Lego", TALVIHAALARI, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI), //
    ...
    LINDEX("Lindex", "Lindex", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI,
            VALIKAUSIHOUSUT, SADEHAALARI, VILLAHAALARI), //
    LUHTA("Luhta", "Luhta", TALVIHAALARI, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI), //
    MOTION("Motion", "Motion's", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI,
            VALIKAUSIHOUSUT, SADEHAALARI, VILLAHAALARI), //
    MYNIMO("Mynimo", "Mynimo", TALVIHAALARI, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI), //
    MOLO("Molo", "Molo Kids", TALVIHAALARI, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI), //
