...
public enum Brand {
    ...
    JONATHAN("Jonathan", "Jonathan", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI,
            VALIKAUSIHOUSUT, SADEHAALARI, VILLAHAALARI), //
    HALTI("Halti", "Halti", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, VALIKAUSIHAALARI, SADEHAALARI, TALVIKENGAT,
            VALIKAUSIKENGAT), //
    ...
    LEGO("Lego", "Lego", TALVIHAALARI, TALVITAKKI, TALVIHOUSUT, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI), //
    ...
    LINDEX("Lindex", "Lindex", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI,
            VALIKAUSIHOUSUT, SADEHAALARI, VILLAHAALARI), //
    LUHTA("Luhta", "Luhta", TALVIHAALARI, TALVITAKKI, TALVIHOUSUT, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI), //
    MCKINLEY("Mckinley", "Mckinley", TALVIHAALARI, TALVITAKKI, TALVIHOUSUT, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI), //
    MOTION("Motion", "Motion's", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI,
            VALIKAUSIHOUSUT, SADEHAALARI, VILLAHAALARI), //
    MYNIMO("Mynimo", "Mynimo", TALVIHAALARI, TALVITAKKI, TALVIHOUSUT, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI), //
    MOLO("Molo", "Molo Kids", TALVIHAALARI, TALVITAKKI, TALVIHOUSUT, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, SADEHAALARI), //
