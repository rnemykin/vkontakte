...
public enum Brand {
    ...
    CLARKS("Clarks", "Clarks", LENKKARIT, TALVIKENGAT, VALIKAUSIKENGAT), //
    COLORKIDS("Color", "Color Kids", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI,
            VALIKAUSIHOUSUT, SADEHAALARI, VILLAHAALARI), //
    COLUMBIA("Columbia", "Columbia", LENKKARIT, TALVIKENGAT, VALIKAUSIKENGAT), //
    ...
    HALTI("Halti", "Halti", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSITAKKI, VALIKAUSIHOUSUT, VALIKAUSIHAALARI,
            SADEHAALARI, TALVIKENGAT, VALIKAUSIKENGAT), //
    HELLYHANSEN("Helly", "Helly Hansen", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, TALVIKENGAT,
    ...
    ICEPEAK("Ice", "Icepeak", TALVIHAALARI, TALVITAKKI, TALVIHOUSUT, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT,
            SADEHAALARI), //
    KAMIK("Kamik", "Kamik", LENKKARIT, TALVIKENGAT, VALIKAUSIKENGAT), //            
    ...
    KULING("Kuling", "Kuling", TALVIHAALARI), //
    ...
    LINDEX("Lindex", "Lindex", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI,
            VALIKAUSIHOUSUT, SADEHAALARI, VILLAHAALARI), //
    LITTLEPIECES("Pieces", "Little Pieces", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI,
                    VALIKAUSIHOUSUT, SADEHAALARI, VILLAHAALARI), //
    ...
    METOO("Me Too", "Me Too", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT,
            SADEHAALARI, VILLAHAALARI), //
    MINIATURE("Mini a Ture", "Mini a Ture", SADEHAALARI), //
    ...
    NOVASTAR("Nova Star", "Nova Star", TALVIHAALARI, TALVIHOUSUT, TALVITAKKI, VALIKAUSIHAALARI, VALIKAUSITAKKI, VALIKAUSIHOUSUT,
            SADEHAALARI, VILLAHAALARI), //
    ...
    SOREL("Sorel", "Sorel", LENKKARIT, TALVIKENGAT, VALIKAUSIKENGAT), //    
