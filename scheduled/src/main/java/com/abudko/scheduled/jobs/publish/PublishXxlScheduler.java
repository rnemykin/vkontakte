...
public class PublishXxlScheduler implements Scheduler {
	...
	public void schedule() {
        log.info("********* Start Publish Xxl Scheduler *******");
        try {
            publish();

            log.info("********* End Publish Xxl Scheduler *******");

        } catch (Exception e) {
            log.error("Exception happened during Publish Xxl Scheduler: ", e);
